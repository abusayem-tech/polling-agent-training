        ...
        <div className="container mx-auto flex justify-between items-center gap-2">
          ...
          <div className="flex-1 flex justify-center max-w-[120px] md:max-w-[200px]">
            <div className="flex items-center gap-2 w-full">
              ...
              <span className="text-[9px] sm:text-[10px] md:text-xs font-bold text-slate-400 whitespace-nowrap">ভিডিও ৭/৭</span>
            </div>
          </div>
          <div className="flex items-center gap-1.5 md:gap-2">
            ...
            />
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-widest hidden sm:inline">Final Stage</span>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-3 sm:space-y-4 md:space-y-6">
            <div className="space-y-1 sm:space-y-2 text-center md:text-left">
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black text-slate-800 leading-tight">পর্ব ০৬: ভোট পরবর্তী প্যাকেট পরিচিতি</h1>
              <p className="text-xs sm:text-sm md:text-base text-slate-500">ভোট পরবর্তী প্যাকেট সম্পর্কে জানুন।</p>
            </div>
            ...
            <div className="bg-white p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 md:gap-6">
              <div className="flex items-center gap-2 sm:gap-3 md:gap-4 w-full sm:w-auto">
                <div className={cn(
                  ...
                  {v7Completed ? <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" /> : <Clock className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />}
                </div>
                <div className="min-w-0 flex-1">
                  <p className="font-bold text-xs sm:text-sm md:text-base text-slate-800">চূড়ান্ত ধাপ</p>
                  <p className="text-[9px] sm:text-[10px] md:text-xs text-slate-500">প্রশিক্ষণ সম্পন্ন করে সার্টিফিকেট নিন</p>
                </div>
              </div>
              ...
              {!v7Completed ? (
                ...
                <Link href="/congratulations" className="w-full sm:w-auto">
                  <Button className="w-full bg-bangladesh-green hover:bg-bangladesh-green/90 h-11 md:h-12 px-6 rounded-xl font-bold shadow-lg shadow-bangladesh-green/20 text-xs sm:text-sm md:text-base">
                    <Award className="mr-2 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />

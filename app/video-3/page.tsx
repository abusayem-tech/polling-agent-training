        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            <div className="space-y-1 md:space-y-2 text-center md:text-left">
              <h1 className="text-xl md:text-3xl font-black text-slate-800 leading-tight">পর্ব ০২: পোলিং এজেন্ট এর নির্দেশিকা</h1>
              <p className="text-sm md:text-base text-slate-500">পোলিং এজেন্ট হিসেবে আপনার নির্দেশিকা ও দায়িত্ব সম্পর্কে জানুন।</p>
            </div>
            ...
            <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-6">
              <div className="flex items-center gap-3 md:gap-4 w-full sm:w-auto">
                <div className={cn(
                  ...
                  {v3Completed ? <CheckCircle2 className="w-6 h-6" /> : <Clock className="w-6 h-6" />}
                </div>
                <div>
